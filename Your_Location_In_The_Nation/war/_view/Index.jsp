...
<div class="featbox2">
    ...
    <p class="pcolor">We have a search feature <br> that can help you if <br> you are not sure of a location.</p>
</div>

<div class="featbox3">
    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDJ9-SsSKAIIFVgKbZjpmHQYdo9PG2i_CPIA&usqp=CAU" alt="search">
    <p class="pcolor">We have a huge database<br>full of the information <br>you see in our page.</p>
</div>
</body>
</html>